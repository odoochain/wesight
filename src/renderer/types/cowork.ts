...
export type { ClaudeCodePermissionMode, DeepSeekTuiPermissionMode, KimiCodePermissionMode, OpenCodePermissionMode, OpenSquillaPermissionMode, QwenCodePermissionMode, CodeBuddyPermissionMode };
...
export type CliAppType = 'claude' | 'codex' | 'hermes' | 'openclaw' | 'opencode' | 'grok' | 'qwen' | 'deepseek_tui' | 'opensquilla' | 'kimi' | 'codebuddy';
